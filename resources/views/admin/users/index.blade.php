    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="mt-6 bg-blue-50 dark:bg-blue-900 p-4 rounded-lg">
                <h3 class="font-semibold text-blue-800 dark:text-blue-200 mb-2">💡 Acciones disponibles:</h3>
                <ul class="text-sm text-blue-700 dark:text-blue-300 space-y-1">
                    <li><span class="font-semibold">🔑</span> Cambiar contraseña</li>
                    <li><span class="font-semibold">👤</span> Cambiar rol</li>
                    <li><span class="font-semibold">🗑️</span> Eliminar usuario</li>
                </ul>
            </div>
        </div>
    </div>
